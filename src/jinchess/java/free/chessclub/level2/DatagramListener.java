...
/**
 * The listener interface for listening to ICC datagram events.
 */
...
public interface DatagramListener extends EventListener{
  ...
  /**
   * Gets invoked when a datagram arrives from the ICC server.
   */
   
  void datagramReceived(DatagramEvent evt);
