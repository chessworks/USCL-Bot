...
public class Packet{
  ...
  /**
   * The client tag (the "arbitrary-word" in formats.txt). May be
   * <code>null</code>.
   */
  ...
  /**
   * The contents of the packet. May be datagrams, other packets, lines of text
   * or anything else the server may decide to send in the future.
   */
   ...
   * @param clientTag The client tag ("arbitrary-word" in formats.txt). May be
   * <code>null</code>.
  ...
  /**
   * Returns the client tag ("arbitrary-word" in formats.txt). May be
   * <code>null</code>.
   */
